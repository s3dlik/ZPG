...
PhongShader::PhongShader(Camera* cam, const char* vertexFile, const char* fragmentFile) : AbstractShader(cam, vertexFile, fragmentFile)
{
}

void PhongShader::activateSh(glm::mat4 M, glm::vec4 color)
{
	glm::vec3 lightPos[4];
...
void PhongShader::activateFlashLight(int mod)
{
